...
export const getMedicamento = async () => {
  ...
  export const updateMedicamento = async (id_medicamento, data) => {
    try {
      console.log("aqui id_medicamento: ", id_medicamento);
      console.log("aqui dat: ", data);
      const response = await api.put(`/medicamento/${id_medicamento}`, data);
      return response.data;
    } catch (error) {
      throw new Error(error);
    }
